    ...
    <section id='magicWithUs' className='magic-with-us-bg-con d-flex flex-column align-items-center'>
      ...
      <div className='magic-with-us-img-info-con-in-lg '>
          <div className='magic-with-us-left-cards-con'>
            ...
            <div className='magic-card1  d-flex align-items-center'>
              ...
              <img className='magic-card-logo' src='images/Frame 427319094.png' alt=''/>
            </div>

            <div className='magic-card2  d-flex align-items-center'>
              <div className='magic-card-des-con magic-left-card'>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p text-end'>
                    Get treatments made just for you based on your individual doshas ( body type)
              ...
              <img className='magic-card-logo' src='images/Frame 427319095.png' alt=''/>
            </div>

            <div className='magic-card3 d-flex align-items-center'>
              <div className='magic-card-des-con magic-left-card'>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p text-end'>
                    Get treatments made just for you based on your individual doshas ( body type)
              ...
              <img className='magic-card-logo' src='images/Frame 427319096.png' alt=''/>
            </div>
          ...
          <div className='magic-with-us-right-cards-con'>
            ...
            <div className='magic-card4  d-flex align-items-center' >
              <img className='magic-card-logo' src='images/Frame 427319099.png' alt=''/>
            ...
            <div className='magic-card5  d-flex align-items-center'>
              <img className='magic-card-logo' src='images/Frame 427319098.png' alt=''/>
              <div className='magic-card-des-con magic-right-card'>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
            ...
            <div className='magic-card6  d-flex align-items-center'>
              <img className='magic-card-logo' src='images/Frame 427319097.png' alt=''/>
              <div className='magic-card-des-con magic-right-card'>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
      ...
      <div className='magic-with-us-img-info-con-in-sm d-md-none'>
        ...
        <div className='magis-with-us-img-con-sm'>
          ...
          <div className='magic-with-us-sm-cards-con'>
            ...
            <div className='magic-with-us-sm-card d-flex flex-column'>
                <img className='magic-card-sm-img' alt='icon' src='images/Frame 427319095.png'/>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
                </p>
            ...
            <div className='magic-with-us-sm-card d-flex flex-column'>
                <img className='magic-card-sm-img' alt='icon' src='images/Frame 427319096.png'/>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
                </p>
            ...
            <div className='magic-with-us-sm-card d-flex flex-column'>
                <img className='magic-card-sm-img' alt='icon' src='images/Frame 427319099.png'/>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
                </p>
            ...
            <div className='magic-with-us-sm-card d-flex flex-column'>
                <img className='magic-card-sm-img' alt='icon' src='images/Frame 427319098.png'/>
                <h4 className='magic-card-hea'>Personalized Wellness</h4>
                <p className='magic-card-p'>
                    Get treatments made just for you based on your individual doshas ( body type)
                </p>
